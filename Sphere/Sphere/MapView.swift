...
class MapView : UIView {
     ...
     */
    func createMarker(venue: VenueData, info: (Int, [String])?) -> (GMSMarker, GMSCircle) {
        ...
        marker.snippet = info == nil ? "Pop, Rock, Family Friendly" : Array(info!.1[0...2]).joined(separator: ", ")
        marker.map = self.gmapView
